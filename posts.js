...
function listEntries(q) {
    ...
    for (var f = 0; f < c.numPost; f++) {
        ...
        g = ("media$thumbnail" in p[f]) ? '<img src="' + p[f].media$thumbnail.url.replace(/\/s72(\-c)?\//, "/s" + c.thumbSize + "-c/") + '" style="width:100%;height:150px;" width="72" height="72">' : '<span class="fake-img" style="width:250px;height:150px;"></span>';
